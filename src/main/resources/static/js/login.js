$(document).ready(function (e) {
    ...
    $("#in").blur(function () {
        $('#user_area').css('border', '1px solid #CCC');
    });
    $("#in").focus(function () {
        $('#user_area').css('border', '1px solid #0CF');
    });
    $("#pwd_in").blur(function () {
        $('#pwd_area').css('border', '1px solid #CCC');
    });
    $("#pwd_in").focus(function () {
        $('#pwd_area').css('border', '1px solid #0CF');
    });
