...
@MapperScan(basePackages = "cn.com.boke.mapper")
public class MyBatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactoryBean() throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath:/cn/com/boke/mapper/*.xml"));//加载mapper配置文件
