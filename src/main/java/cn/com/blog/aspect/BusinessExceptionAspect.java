...
public class BusinessExceptionAspect {
    ...
    @Pointcut("execution(* cn.com.blog.service.*.*(..))")
    ...
    public void methodsAnnotatedWithBusinessLog(JoinPoint joinPoint, Exception exception) {
        if (exception instanceof BusinessException) {
            logger.error("==>cn.ocm.blog.exception.BusinessException");
            ...
            logger.error("==>cn.ocm.blog.exception.Exception");
